...
function AppContent() {
  ...
  const state = useState({
    ...
    hasLeftLandingPage: localStorage.getItem("hasLeftLandingPage") === "true",
    currentView: "calendar" as "calendar" | "activity",
    activityYear: new Date().getFullYear(),
    isLoadingActivity: false,
    shouldPulsate: false,
    pendingView: null as "calendar" | "activity" | null,
    previousWeekDialog: null as PreviousWeekDialog | null,
  });
  const onboarding = OnboardingContext.inject();
